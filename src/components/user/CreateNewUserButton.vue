<template>
  <button @click="openCreateNewUserModal"
    class="hover:scale-105 duration-300 text-white px-6 py-3 cursor-pointer rounded-full shadow-lg text-sm transition-all">
    {{ CreateNewUserText }}
  </button>
</template>
